...
PROTOBUF_NAMESPACE_OPEN
template<> ::Erbing::Person* Arena::CreateMaybeMessage<::Erbing::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Erbing {
...
class Person final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Erbing.Person) */ {
 public:
  ...
  PROTOBUF_NODISCARD ::Dabing::Address* release_addr();
  ::Dabing::Address* mutable_addr();
  void set_allocated_addr(::Dabing::Address* addr);
  private:
  const ::Dabing::Address& _internal_addr() const;
  ::Dabing::Address* _internal_mutable_addr();
  public:
  void unsafe_arena_set_allocated_addr(
      ::Dabing::Address* addr);
  ::Dabing::Address* unsafe_arena_release_addr();
  ...
  private:
  ::Erbing::Color _internal_color() const;
  void _internal_set_color(::Erbing::Color value);
  public:
...
inline const ::Dabing::Address& Person::_internal_addr() const {
  const ::Dabing::Address* p = _impl_.addr_;
  return p != nullptr ? *p : reinterpret_cast<const ::Dabing::Address&>(
...
inline void Person::unsafe_arena_set_allocated_addr(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Erbing.Person.addr)
}
inline ::Dabing::Address* Person::release_addr() {
  
  ::Dabing::Address* temp = _impl_.addr_;
...
inline ::Dabing::Address* Person::unsafe_arena_release_addr() {
...
inline ::Dabing::Address* Person::_internal_mutable_addr() {
  
  if (_impl_.addr_ == nullptr) {
    auto* p = CreateMaybeMessage<::Dabing::Address>(GetArenaForAllocation());
    _impl_.addr_ = p;
  }
  return _impl_.addr_;
}
inline ::Dabing::Address* Person::mutable_addr() {
  ::Dabing::Address* _msg = _internal_mutable_addr();
...
inline ::Erbing::Color Person::_internal_color() const {
  return static_cast< ::Erbing::Color >(_impl_.color_);
}
inline ::Erbing::Color Person::color() const {
  // @@protoc_insertion_point(field_get:Erbing.Person.color)
  return _internal_color();
}
inline void Person::_internal_set_color(::Erbing::Color value) {
...
template <> struct is_proto_enum< ::Erbing::Color> : ::std::true_type {};
template <>
